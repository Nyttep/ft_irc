...
/*   Updated: 2023/10/05 18:53:39 by mportrai         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (chantypes(targets[i][0]) == true || correct_nick(targets[i]) == false)
	{
...
void	execute_KICK(Command& command, Server& server)
{
	...
	if (chantypes(command.getParams()[0][0]) == false || correct_chan(command.getParams()[0]) == false)
	{
